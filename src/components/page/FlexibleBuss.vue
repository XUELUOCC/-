    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item><i class="el-icon-wallet"></i> 灵活就业补贴统计</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form">
            ...
            <div class="echart-content">
                <div class="title">灵活就业补贴职位统计</div>
                <div id="chartFee" style="width:auto;height:500px"></div>
            </div>
