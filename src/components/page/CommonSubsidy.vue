    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                ...
                <el-breadcrumb-item><i class="el-icon-money"></i> 公益性补贴统计</el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="form">
            ...
            <!-- <div class="chartFee" style="width:100%;height:500px;"></div> -->
 ...
 import echarts from 'echarts'
    ...
    export default {
        ...
        methods:{
            ...
            add(){
                if(this.bussName=='' || this.bussPerson=='' || this.bussPhone=='' || this.bussNature=='' || this.bussSubsidy=='' || this.bussConnect==''){
                    return false;
                }
                var newData= {
